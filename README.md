...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
      SQL is the language used to query databases. Relational Databases is a particular model that the database follows.

- [ ] Why do tables need a `primary key`?
      They need a primary key to make a row unique.
